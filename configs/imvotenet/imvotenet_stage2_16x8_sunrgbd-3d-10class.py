...
model = dict(
    pts_backbone=dict(
        ...
        fps_mod_list=[['D-FPS'], ['D-FPS'], ['D-FPS'], ['D-FPS']],
...
load_from = '/mnt/cache/xietao/mmdetection3d/configs/imvotenet/imvotenet_faster_rcnn_r50_fpn_2x4_sunrgbd-3d-10class_20210819_225618-62eba6ce.pth'  # noqa
